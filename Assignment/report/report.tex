...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot table {Task_2/TPR.dat};
      \addplot table {Task_2/FPR.dat};
    \end{axis}
  \end{tikzpicture}
...
\begin{figure}[H]
  \centering
  \subfloat[dart4.jpg.]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_2/out4.jpg}\label{fig:out4}}
  \hfill
  \subfloat[dart5.jpg]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_2/out11.jpg}\label{fig:out11}}
   \hfill
  \subfloat[dart13.jpg]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_2/out14.jpg}\label{fig:out14}}
   \hfill
  \subfloat[dart14.jpg]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_2/out15.jpg}\label{fig:out15}}
   \hfill
...
\begin{figure}[H]
  \centering
  \subfloat[Threshold Gradient Magnitude.]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:mag1}}
  \hfill
  \subfloat[Hough Space]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:hough1}}
   \hfill
  \subfloat[Result]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:result1}}
   \hfill
...
\begin{figure}[H]
  \centering
  \subfloat[Threshold Gradient Magnitude.]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:mag2}}
  \hfill
  \subfloat[Hough Space]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:hough2}}
   \hfill
  \subfloat[Result]{\includegraphics[width=\textwidth, height=20mm, keepaspectratio]{Task_3/test.jpeg}\label{fig:result2}}
   \hfill
...
\begin{figure}[H]
  \centering
  \subfloat[Flowchart representing the detector.]{\includegraphics[width=\textwidth, height=40mm, keepaspectratio]{Task_3/flowchart.png}\label{fig:flowchart}}
\end{figure}
...
In order to select an appropriate threshold for each image, the Otsu method can be applied. [https://en.wikipedia.org/wiki/Otsu%27s_method]
